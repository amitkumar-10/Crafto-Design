...
export default function Contact() {
  const [form, setForm] = React.useState({ name: '', phone: '', email:'', location: '', message: '' })
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid md:grid-cols-2 gap-8">
        ...
        <form onSubmit={onSubmit} className="bg-white rounded-2xl shadow border p-6 space-y-4">
          ...
          <div>
            ...
            <input placeholder="Enter your project location" name="location" value={form.location} onChange={handleChange} className="w-full border rounded-md px-3 py-2" />
          </div>
          <div>
